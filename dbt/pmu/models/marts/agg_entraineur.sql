...
SELECT
    ...
    participant_entraineur AS entraineur,

    -- volumes
    count(*) AS nb_participations,
    count(DISTINCT participant_id_cheval) AS nb_chevaux_distincts,
...
WHERE participant_entraineur IS NOT NULL

GROUP BY participant_entraineur
