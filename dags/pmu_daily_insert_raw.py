...
def pmu_daily_insert_raw():
    ...
    current_date = start()
    course_stats = load_raw_courses(current_date)
    participant_stats = load_raw_participants(current_date)
    report_task = report_backfill(course_stats, participant_stats)
    watcher_task = watcher()

    current_date >> [course_stats, participant_stats]
    [current_date, course_stats, participant_stats, report_task] >> watcher_task
